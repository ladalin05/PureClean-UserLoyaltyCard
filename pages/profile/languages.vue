<template>
  <v-app>
    <v-main
      class="bg-[#FFFFFF] dark:bg-[#191919] font-roboto"
      ...
      <v-container class="pa-6 pt-12">
        ...
        <header class="d-flex justify-between mb-12 py-1 align-center">
          <nuxt-link to="/profile">
            <v-icon size="28" class=" dark:text-[#FFFFFF]">
              mdi-chevron-left
            </v-icon>
          </nuxt-link>

          <p
            class="font-medium text-[20px] leading-[30px] tracking-normal dark:text-[#FFFFFF]"
          >
            {{ translate('languages') }}
          </p>
            ...
            <v-list-item
              ...
              :class="
                selectedLanguage === lang.code
                  ? '!bg-[#EAEFF2] !text-[#35667D]'
                  : '!bg-transparent dark:!bg-[#323232] dark:text-[#FFFFFF]'
              "
            >
